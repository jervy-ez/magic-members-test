...
// -----------------------------------------------------------------------
/**
 * Magic Members post taxonomy class
 * extends object to save options to database
 *
 * @package MagicMembers
 * @since 2.5.1
 */  
class mgm_post_taxonomy extends mgm_object{		
	
	// construct
	function __construct($fields=false){
		// php4
		$this->mgm_post_taxonomy($fields);
	}
	
	// construct
	function mgm_post_taxonomy($fields=false){
		// parent
		parent::__construct(); 
		// defaults
	...
	function _set_defaults($fields=false){
		...
		$this->code        = __CLASS__;
		// name
		$this->name        = 'Post Taxonomy Lib';
		// description
		$this->description = 'Post Taxonomy Lib';
