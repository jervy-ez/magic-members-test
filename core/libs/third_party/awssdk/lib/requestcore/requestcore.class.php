...
class RequestCore
{
	...
	public function prep_request()
	{
		...
		curl_setopt($curl_handle, CURLOPT_SSL_VERIFYPEER, (boolean)$this->ssl_verification);
		curl_setopt($curl_handle, CURLOPT_SSL_VERIFYHOST, (boolean)$this->ssl_verification);
		
		// chmod the file as 0755
		if ($this->cacert_location === true)
		{
			curl_setopt($curl_handle, CURLOPT_CAINFO, dirname(__FILE__) . DIRECTORY_SEPARATOR . 'cacert.pem');
		}
