...
class mgm_authorizenet extends mgm_payment{
	...
	function _setup_endpoints($end_points = array()){
		...
		$end_points_default = array('test_sim' => 'https://test.authorize.net/gateway/transact.dll',
									'live_sim' => 'https://secure.authorize.net/gateway/transact.dll',
									'test_aim' => 'https://test.authorize.net/gateway/transact.dll',
									'live_aim' => 'https://secure.authorize.net/gateway/transact.dll',
									'test_arb' => 'https://apitest.authorize.net/xml/v1/request.api',
									'live_arb' => 'https://api.authorize.net/xml/v1/request.api');	
		// merge
	...
	function _get_alternate_transaction_id(){
		...
		if(isset($_POST['x_custom']) && !empty($_POST['x_custom'])){
			...
			$alt_tran_id = strip_tags($_GET['x_custom']);
		}		
		// return 
		return $alt_tran_id;
	}
